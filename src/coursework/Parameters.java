...
public class Parameters {
	 ...
	 * 
	 */
	//selection: tournament, random, roulette, elitist
	//reproduction: onePoint, twoPoint, uniform and arithmetic crossovers
	//replacement: worst, deterministic, restrictedTS, best
	//mutation: inversion, swap, creep, standard
	
	public static String selection = "random"; 
	public static String reproduction = "uniform";
	public static String mutation ="standard";
	public static String replacement = "restrictedTS";
	
	public static int tournamentSize = 10;
	public static double aritmetic = 0.7;
